const adventureName = 'Expanse Bonus Pack';
const moduleName = 'expanse-bonus-pack';
 ...
 *   const creaturePacks = [];
 */
const creaturePacks = [`${moduleName}.bonus-actors`];
/**
 ...
 *   const journalPacks = [];
 */
// const journalPacks = [`${moduleName}.bonus-actor-notes`];
const journalPacks = [];
/**
